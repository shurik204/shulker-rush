...
execute if score #TCount var matches ..1 run tellraw @a {"text":"Недостаточно игроков для начала игры","color":"red"}
...
execute if score #TCount var matches 2.. if score #BCount var matches 0 if score #PCount var matches 0 run tellraw @a {"text":"В синей команде никого нет","color":"red"}
execute if score #TCount var matches 2.. if score #YCount var matches 0 if score #PCount var matches 0 run tellraw @a {"text":"В жёлтой команде никого нет","color":"red"}
