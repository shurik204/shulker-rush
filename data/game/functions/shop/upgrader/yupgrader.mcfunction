...
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpY,limit=1] swordLvl matches 0 if score @e[type=area_effect_cloud,tag=UpY,limit=1] statSouls matches 4.. run scoreboard players set @s buyID 3
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpY,limit=1] swordLvl matches 1 if score @e[type=area_effect_cloud,tag=UpY,limit=1] statSouls matches 7.. run scoreboard players set @s buyID 3
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpY,limit=1] swordLvl matches 2 if score @e[type=area_effect_cloud,tag=UpY,limit=1] statSouls matches 11.. run scoreboard players set @s buyID 3
execute if score @s result matches 1 run scoreboard players set @s clearDetect -1
execute store success score @s result run clear @s minecraft:iron_chestplate{U:1}
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpY,limit=1] armorLvl matches 0 if score @e[type=area_effect_cloud,tag=UpY,limit=1] statSouls matches 4.. run scoreboard players set @s buyID 4
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpY,limit=1] armorLvl matches 1 if score @e[type=area_effect_cloud,tag=UpY,limit=1] statSouls matches 6.. run scoreboard players set @s buyID 4
