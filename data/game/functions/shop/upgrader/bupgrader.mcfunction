...
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpB,limit=1] effectLvl matches 0 if score @e[type=area_effect_cloud,tag=UpB,limit=1] statSouls matches 4.. run scoreboard players set @s buyID 2
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpB,limit=1] effectLvl matches 1 if score @e[type=area_effect_cloud,tag=UpB,limit=1] statSouls matches 5.. run scoreboard players set @s buyID 2
...
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpB,limit=1] effectLvl matches 0 if score @e[type=area_effect_cloud,tag=UpB,limit=1] statSouls matches 2.. run scoreboard players set @s buyID 5
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpB,limit=1] effectLvl matches 1 if score @e[type=area_effect_cloud,tag=UpB,limit=1] statSouls matches 5.. run scoreboard players set @s buyID 5
execute if score @s result matches 1 if score @e[type=area_effect_cloud,tag=UpB,limit=1] effectLvl matches 2 if score @e[type=area_effect_cloud,tag=UpB,limit=1] statSouls matches 10.. run scoreboard players set @s buyID 5
execute if score @s result matches 1 run scoreboard players set @s clearDetect -1
