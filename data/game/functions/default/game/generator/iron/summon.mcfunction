...
execute unless entity @a[distance=..1.5,gamemode=adventure] run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:iron_nugget",Count:1b,tag:{HideFlags:127,CanDestroy:["#game:destroy"]}},Tags:["GenItem"]}
