...
# Wooden pickaxe
give @s[tag=!eliminated] minecraft:wooden_pickaxe{display:{Name:'{"translate":"item.minecraft.wooden_pickaxe","color":"white","italic":false}'},HideFlags:127,Unbreakable:1b,CanDestroy:["#game:destroy"],Enchantments:[{id:"minecraft:vanishing_curse",lvl:1}]}
