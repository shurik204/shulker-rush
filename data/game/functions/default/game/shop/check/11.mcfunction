...
execute if score @s buyID matches 11 if score @s ArmorType matches 2 run scoreboard players set @s buyID -2
# If player have better armor
execute if score @s buyID matches 11 if score @s ArmorType matches 3.. run scoreboard players set @s buyID -3