...
execute if score @s Uresult matches 1.. run function game:default/game/upgrader/yellow/check/1

execute store result score @s Uresult run clear @s minecraft:golden_carrot{U:1}
execute if score @s Uresult matches 1.. run function game:default/game/upgrader/yellow/check/2

execute store result score @s Uresult run clear @s minecraft:iron_sword{U:1}
execute if score @s Uresult matches 1.. run function game:default/game/upgrader/yellow/check/3

execute store result score @s Uresult run clear @s minecraft:iron_chestplate{U:1}
execute if score @s Uresult matches 1.. run function game:default/game/upgrader/yellow/check/4

execute store result score @s Uresult run clear @s minecraft:brewing_stand{U:1}
execute if score @s Uresult matches 1.. run function game:default/game/upgrader/yellow/check/5

execute if score @s UbuyID matches 1.. run function game:default/game/upgrader/yellow/success
