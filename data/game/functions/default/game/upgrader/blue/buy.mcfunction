...
execute if score @s Uresult matches 1.. run function #item:bupgrader_check_1

execute store result score @s Uresult run clear @s minecraft:golden_carrot{U:1}
execute if score @s Uresult matches 1.. run function #item:bupgrader_check_2

execute store result score @s Uresult run clear @s minecraft:iron_sword{U:1}
execute if score @s Uresult matches 1.. run function #item:bupgrader_check_3

execute store result score @s Uresult run clear @s minecraft:iron_chestplate{U:1}
execute if score @s Uresult matches 1.. run function #item:bupgrader_check_4

execute store result score @s Uresult run clear @s minecraft:brewing_stand{U:1}
execute if score @s Uresult matches 1.. run function #item:bupgrader_check_5
