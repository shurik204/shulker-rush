...
data modify block 1002 180 1156 Text4 set value '{"text":"Code version: 1.1"}'
...
schedule clear game:lobby/reinvis_villager4
schedule function game:lobby/reinvis_villager 10s
