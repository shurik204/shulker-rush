...
# Summon ruby
execute if score @s rubyGen matches ..0 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:nether_wart",Count:1b,tag:{display:{Name:'{"text":"Рубин","color":"red","italic":false}'},HideFlags:127,CanDestroy:["oak_planks","#game:stained_glass","obsidian","end_stone","cobweb"]}}}
